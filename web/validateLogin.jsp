...
<%
    ...
    /**
     * Obtém parâmetros enviados pela página de login para
     * validar ser o usuário possuí um cadastro.
     * Esta validação aplica-se apenas a usuários do tipo: ESPCHAT.
     * Demais usuários serão válidados pelas respectivas APIS. 
     * (Facebook,Twitter,Google Plus). Serão cadastrados apenas
     * a título de histórico de participação na salda de bate-papo.
     * 
     */
